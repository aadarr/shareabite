...
Public Class IndividualDetails
    ...
    Private Sub IndividualDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        xComm.CommandText = "SELECT id, name, contact, address FROM individual WHERE username=@xUserName"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        cmd.Connection = con
        cmd.CommandText = "UPDATE individual SET name=@name,contact=@contact, address=@address WHERE id=@id"
        ...
        End Try
        MessageBox.Show("You have successfully updated your individual Details")
        Me.Close()
    End Sub
